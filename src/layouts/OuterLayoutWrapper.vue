<template>
  <v-app>
    ...
    <OuterNavbar v-if="data?.ui?.navbarComponent === '1'" :config="data?.ui" />
    <OuterNavbar2 v-else-if="data?.ui?.navbarComponent === '2'" :config="data?.ui" />
    <OuterNavbar3 v-else-if="data?.ui?.navbarComponent === '3'" :config="data?.ui" />
    <OuterNavbar4 v-else-if="data?.ui?.navbarComponent === '4'" :config="data?.ui" />
    ...
    <OuterFooter2 v-else-if="data?.ui?.footerComponent === '2'" :config="data?.ui" />
  </v-app>
</template>
