  ...
  >
    ...
    >
      <div class="w-100" style="max-width: 500px">
        ...
        <v-btn variant="text" color="light" size="small" class="ma-2" @click="navigateHome">
        ...
        <v-card class="mt-4" variant="text">
          <v-card-text class="text-center">
            ...
            <div class="text-body-2 text-medium-emphasis mb-2">Or continue with</div>

            <!-- Social Login Options (static) -->
            <v-row no-gutters justify="center">
              <v-col cols="auto">
                <v-btn variant="outlined" color="light" size="small" disabled class="mx-1">
            ...
            <div class="text-caption text-medium-emphasis mt-2">Social login coming soon</div>
          </v-card-text>
        </v-card>
        ...
        <v-card class="mx-auto mt-2" variant="text">
          <v-card-actions class="justify-center">
            <v-btn variant="text" color="light" size="small" @click="toggleMode">
