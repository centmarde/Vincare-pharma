      ...
      <v-col cols="12" sm="8" md="6" lg="4">
        <v-container class="mx-auto text-center" elevation="8" rounded="lg">
          <v-card-text class="py-8">
            ...
            <!-- Error Title -->
            <div class="text-h4 font-weight-light mb-4 text-error">Access Forbidden</div>

            <!-- Error Description -->
            <div class="text-body-1 text-medium-emphasis mb-6">
              You don't have permission to access this resource. This might be because your user
              role doesn't include access to this page, or your session has expired.
            </div>
