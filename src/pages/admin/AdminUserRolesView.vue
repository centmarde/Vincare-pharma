    ...
    <template #content>
      <v-container fluid class="pa-6">
          ...
          <v-col cols="12">
            <div class="d-flex justify-space-between align-center">
              <div>
                ...
                <p class="text-body-1 text-grey-darken-1">Manage system roles and permissions</p>
              </div>
            </div>
          </v-col>
        </v-row>
          ...
          <v-col cols="12" sm="6" md="4" lg="3">
            ...
            >
              <v-card-text class="pa-4">
                ...
                <h3 class="text-h6 font-weight-medium mb-2 text-primary">Add New Role</h3>
        ...
        <v-row v-if="filteredRoles.length === 0 && searchQuery">
          <v-col cols="12">
            <div class="text-center py-12">
              <v-icon size="96" color="grey-lighten-1" class="mb-4"> mdi-magnify </v-icon>
              <h3 class="text-h5 mb-3">No roles match your search</h3>
              <p class="text-body-1 text-grey-darken-1 mb-6">
                Try adjusting your search criteria or create a new role
              </p>
              <div class="d-flex justify-center ga-3">
                <v-btn variant="outlined" @click="searchQuery = ''"> Clear Search </v-btn>
