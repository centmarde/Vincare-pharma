...
<template>
  <div elevation="2" rounded="lg" class="logs-card">
    <!-- Header Section -->
    <v-card-title class="d-flex align-center justify-space-between pa-3 pa-sm-4">
      <div class="d-flex align-center">
        <v-icon icon="mdi-text-box-outline" class="me-2 d-none d-sm-flex" color="primary"></v-icon>
      ...
      <div v-show="!isCollapsed">
        ...
        <v-card-text class="pa-0">
          ...
          <div v-if="isLoading && !hasLogs" class="text-center pa-4 pa-sm-8">
            ...
            ></v-progress-circular>
            <div class="text-body-2 text-sm-body-1 mt-3 mt-sm-4 text-medium-emphasis">
              Loading logs...
            </div>
          </div>
            ...
            <div class="mx-auto timeline-wrapper">
              <div class="timeline-container">
                ...
                >
                  ...
                  <div class="timeline-line">
                    <div class="timeline-dot-container">
                      ...
                      >
                        <v-icon :icon="getTypeIcon(log.type)" color="white" size="16"></v-icon>
                      </v-avatar>
                    </div>
                    <div
                  ...
                  <div class="timeline-content">
                    <v-card elevation="2" rounded="lg" class="timeline-card">
                      ...
                      <v-card-title class="pa-3 pa-sm-4 pb-2">
                        <div
                          class="d-flex flex-column flex-sm-row align-start align-sm-center justify-space-between w-100 ga-2"
                        >
                          <div class="flex-grow-1">
                            ...
                            <!-- Desktop version -->
                            <div
                              class="d-none d-sm-flex align-center text-caption text-medium-emphasis"
                            >
                              <v-icon icon="mdi-tag-outline" size="14" class="me-1"></v-icon>
                              {{ log.version }}
                              <v-divider vertical class="mx-2"></v-divider>
                              <v-icon icon="mdi-clock-outline" size="14" class="me-1"></v-icon>
                              {{ getRelativeTime(log.created_at) }}
                            </div>
                            <!-- Mobile version -->
                            <div class="d-sm-none text-caption text-medium-emphasis">
                              <div class="mb-1">
                                <v-icon icon="mdi-tag-outline" size="12" class="me-1"></v-icon>
                                {{ log.version }}
                              </div>
                              <div>
                                <v-icon icon="mdi-clock-outline" size="12" class="me-1"></v-icon>
                                {{ getRelativeTime(log.created_at) }}
                              </div>
                            </div>
                          </div>
                ...
                >
                  <div class="timeline-line">
                    <div class="timeline-dot-container">
                      <v-avatar size="32" color="primary" class="timeline-dot elevation-2">
                        <v-progress-circular
                          v-if="isLoading"
                          indeterminate
                          color="white"
                          ...
                          width="2"
                        ></v-progress-circular>
                        <v-icon v-else icon="mdi-dots-horizontal" color="white" size="16"></v-icon>
                      </v-avatar>
                    </div>
                  </div>
                  <div class="timeline-content">
                    <v-card elevation="1" rounded="lg" class="pa-3 pa-sm-4" variant="tonal">
                ...
                >
                  <div class="timeline-line">
                    <div class="timeline-dot-container">
                      <v-avatar size="32" color="success" class="timeline-dot elevation-2">
                        <v-icon icon="mdi-check-circle-outline" color="white" size="16"></v-icon>
                      </v-avatar>
                    </div>
                  </div>
                  <div class="timeline-content">
