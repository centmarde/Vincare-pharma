    ...
    <v-dialog v-model="confirmDialog.show" max-width="420" persistent>
      <v-card rounded="lg">
        ...
        <v-card-actions class="px-5 pb-5 pt-3 justify-end ga-2">
          <v-btn variant="outlined" class="text-none" :disabled="loading" @click="confirmDialog.show = false">
            Cancel
          </v-btn>
          <v-btn variant="flat" color="success" class="text-none" :loading="loading" @click="handleMarkReceived">
            Yes, Mark Received
          </v-btn>
        </v-card-actions>
      </v-card>
