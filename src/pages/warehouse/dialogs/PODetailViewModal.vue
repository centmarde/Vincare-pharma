...
import ScannerDialog from './Scanner.vue'
...
function handleImageCaptured(imageData: string) {
  // Handle captured/uploaded image data
  console.log('[PODetailViewModal] Image received from Scanner:', {
    preview: imageData.substring(0, 100) + '...',
    length: imageData.length,
    type: imageData.startsWith('data:image/')
      ? imageData.substring(5, imageData.indexOf(';'))
      : 'unknown',
    sizeKB: Math.round(imageData.length / 1024) + 'KB',
  })
